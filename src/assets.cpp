...
void Assets::init(){
    ...
    this->testSnakeJoints = { jointInfo( {34, 35, 36, 37, 0, 1, 2, 3, 4, 5, 6}, { 0.5, 0.0 },testEye), 
                            jointInfo( {7, 8, 9, 31, 32, 33}, { 0.33333, 0.0 }), 
                            jointInfo( {28, 29, 30, 10, 11, 12}, { 0.13333, 0.0 }), 
                            jointInfo( {25, 26, 27, 13, 14, 15}, { -0.06667, 0.0 }), 
                            jointInfo( {22, 23, 24, 16, 17, 18}, { -0.26667, 0.0 }), 
